 ...
 * Should resolve
 */
test.skip('Siamese Search#Nouns what is your name', async t => {
 ...
 * Should resolve 
 */
test.skip('Siamese Search#Nouns would I know your name', async t => {
 ...
 * Should resolve
 */
test.only('Siamese Search#Nouns What is your favorite animal', async t => {
    let result = await siameseService.searchWithPOSNouns('topic', 'question', 'What is your favorite animal');
    console.log('result(What is your favorite animal):', JSON.stringify(result))
    t.pass()
})
 ...
 */
test.only('Siamese Search#Nouns What is your favorite animal', async t => {
    let result = await siameseService.searchWithPOSNouns('topic', 'question', 'What is favorite animal');
    console.log('result(What is your favorite animal):', JSON.stringify(result))
    t.pass()
})
